...
export const metadata = createPageMetadata({
  title: "Liên hệ — Kết thúc hành trình",
...
export default function ContactPage() {
  return (
    <div className="relative space-y-10 pt-6 md:space-y-12 md:pt-10">
      <section className="relative -mx-2 overflow-hidden rounded-[36px] border border-white/10 bg-[#05070c] px-6 py-12 shadow-[0_32px_110px_rgba(0,0,0,0.6)] sm:-mx-4 lg:-mx-8 md:px-12 md:py-16">
        ...
        <div className="relative z-10 grid gap-12 lg:grid-cols-[1.25fr_0.75fr] lg:items-start">
          <div className="space-y-6">
            <div className="space-y-3">
              <h2 className="font-display text-5xl font-bold uppercase tracking-[0.14em] text-foam sm:text-6xl lg:text-7xl">
                Lời kết
              </h2>
          ...
          <div className="space-y-6">
            <div className="space-y-3 w-full">
              <h3 className="font-display text-4xl font-bold uppercase tracking-[0.14em] text-foam sm:text-5xl">
                Thông tin liên hệ
              </h3>
              <span className="block h-1 w-full rounded-full bg-gradient-to-r from-pearl via-sky-300 to-ember/60" />
            </div>
