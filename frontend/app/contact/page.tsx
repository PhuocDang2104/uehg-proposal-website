...
export default function ContactPage() {
  return (
    <div className="relative space-y-10 md:space-y-12">
      <div className="pointer-events-none absolute -top-6 right-6 h-40 w-40 rounded-full bg-pink-300/20 blur-3xl" />
      <div className="pointer-events-none absolute top-24 left-6 h-32 w-32 rounded-full bg-rose-200/15 blur-3xl" />
