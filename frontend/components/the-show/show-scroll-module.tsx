...
const showSections: ShowSection[] = [
  ...
  },
  {
    ...
    artist: {
      eyebrow: "NGHỆ SĨ",
      name: "T.R.I",
      image: "/artists/tri-placeholder.png",
      imageAlt: "T.R.I placeholder",
      details: [
      ...
      <div ref={containerRef} className="relative w-full px-6 sm:px-10 lg:px-14">
        ...
        <div className="relative z-10 space-y-16 sm:space-y-20 lg:space-y-24">
          {showSections.map((section, index) => {
            ...
            const primaryWidthClasses = hasDraggableDeck ? "max-w-[760px]" : "max-w-[560px]";
                ...
                >
                  ...
                  {section.artist ? (
                    ...
                    >
                      <div
                        className={cn(
                          "relative z-30 w-full max-w-[560px] mt-4 md:mt-6 lg:mt-10",
                          cardWidthClasses,
                        )}
                      >
                        ...
                        <Card className="relative z-10 w-full border-pearl/30 bg-white/95 text-left text-slate-900 shadow-[0_28px_80px_rgba(142,240,255,0.22)]">
