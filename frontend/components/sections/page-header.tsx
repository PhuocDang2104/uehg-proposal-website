...
export const PageHeader = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-river-900/90 via-river-800/80 to-river-900/80 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.35)] md:p-10">
