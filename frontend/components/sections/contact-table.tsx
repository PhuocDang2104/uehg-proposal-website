...
const ContactTableSection = () => {
  return (
    <section className="relative mt-12 overflow-hidden rounded-[32px] border border-white/10 bg-black px-6 py-12 shadow-[0_30px_100px_rgba(0,0,0,0.6)] md:mt-16 md:px-10 md:py-16">
      ...
      <div className="relative z-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="space-y-6">
          ...
          <h2 className="font-display text-5xl leading-none text-foam sm:text-6xl lg:text-7xl">
            Liên hệ
        ...
        >
          <div className="group relative">
            ...
            <input
              ...
              className="h-14 w-full rounded-full border border-white/10 bg-white/10 px-6 text-sm text-foam placeholder:text-foam/40 transition duration-300 focus:border-pearl/60 focus:outline-none focus:ring-2 focus:ring-pearl/40"
            />
          ...
          <div className="group relative">
            ...
            <textarea
              ...
              className="min-h-[140px] w-full rounded-[28px] border border-white/10 bg-white/10 px-6 py-4 text-sm text-foam placeholder:text-foam/40 transition duration-300 focus:border-pearl/60 focus:outline-none focus:ring-2 focus:ring-pearl/40"
            />
            <span className="pointer-events-none absolute inset-0 rounded-[28px] ring-1 ring-transparent transition group-focus-within:ring-pearl/40" />
          </div>
