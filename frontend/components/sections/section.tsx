...
export const Section = ({
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className={clsx(
        "relative w-full space-y-6 rounded-3xl border border-white/10 bg-white/5 p-5 shadow-[0_20px_70px_rgba(0,0,0,0.35)] md:p-8",
        className,
      )}
    >
      ...
      <div
        className={clsx(
          "relative z-10 max-w-3xl space-y-3",
      ...
      >
        ...
        {description && <p className="text-sm text-foam/80">{description}</p>}
      </div>
